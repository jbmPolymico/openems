...
public interface PmhModbus extends OpenemsComponent {
	...
	public enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		...
		DELTA_T_TO_START_DEBUG(Doc.of(OpenemsType.INTEGER)), // 0x001A
		DELTA_T_TO_START(Doc.of(OpenemsType.INTEGER)
				.accessMode(AccessMode.READ_WRITE)
				.unit(Unit.DEGREE_CELSIUS)
				.onChannelSetNextWriteMirrorToDebugChannel(DELTA_T_TO_START_DEBUG)),
		
		DELTA_T_TO_STOP_DEBUG(Doc.of(OpenemsType.INTEGER)), // 0x001B
		...
		HEATING_SETPOINT_DEBUG(Doc.of(OpenemsType.INTEGER)), // 0x002C
		HEATING_SETPOINT(Doc.of(OpenemsType.INTEGER)
				.accessMode(AccessMode.READ_WRITE)
				.unit(Unit.DEGREE_CELSIUS)
				.onChannelSetNextWriteMirrorToDebugChannel(HEATING_SETPOINT_DEBUG)),
		...
		SETPOINT_DHW_REHEATING(Doc.of(OpenemsType.INTEGER) // 0x004A
				.accessMode(AccessMode.READ_ONLY)
				.unit(Unit.DEGREE_CELSIUS)),
		
		RESTART_POINT_DHW_REHEATING(Doc.of(OpenemsType.INTEGER) // 0x004B
				.accessMode(AccessMode.READ_ONLY)
				.unit(Unit.DEGREE_CELSIUS)),
		...
		FAILURE_MAINS_CURRENT(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21C.00
		FAILURE_COMPRESSOR_CURRENT(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21C.01
		FAILURE_IPM_MODULE(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21C.02
		FAILURE_COMPRESSOR_OIL_RETURN(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.03
		FAILURE_HIGH_PRESSURE_ON_SWITCH(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21C.04
		FAILURE_COMPRESSOR_OVERPRESSURE_SHUTDOWN(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.05
		FAILURE_FIRST_START_PREHEAT(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.06
		FAILURE_OUTDORR_GAS_DISCHARGE_TEMP(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.07
		FAILURE_OUTDOOR_COIL_EVAPORATOR_TEMP(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.08
		FAILURE_AC_HIGH_LOW_VOLTAG(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21C.09
		FAILURE_AMBIENT_TEMPERATURE(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21C.10
		FAILURE_FREQUENCY_LIMIT_BY_AMBIENT(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.11
		FAILURE_LOW_PRESSURE_SWITCH(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.12
		FAILURE_COMM_LOST_PANEL(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.13
		FAILURE_COMM_LOST_COMPRESSOR(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.14
		FAILURE_COMPRESSOR_PHASE_OPEN_SHORT(Doc.of(OpenemsType.BOOLEAN)), // 0X21C.15
		
		FAILURE_COMPRESSOR_WORKING_CURRENT(Doc.of(OpenemsType.BOOLEAN)),// 0X21D.00
		FAILURE_COMPRESSOR_DRIVER(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21D.01
		FAILURE_COMPRESSOR_DRIVER_VDC(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21D.02
		FAILURE_AC_CURRENT(Doc.of(OpenemsType.BOOLEAN)), 				// 0X21D.03
		FAILURE_EEPROM(Doc.of(OpenemsType.BOOLEAN)), 					// 0X21D.04
		FAILURE_AMBIENT_TEMPERATURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)),// 0X21D.05
		FAILURE_OUTDOOR_COIL_TEMPERATURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), // 0X21D.06
		FAILURE_COMPRESSOR_DISCHARGE_TEMPERATURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), // 0X21D.07
		FAILURE_COMPRESSOR_SUCTION_TEMPERATURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), // 0X21D.08
		FAILURE_LOW_PRESSURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21D.09
		FAILURE_HIGH_PRESSURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21D.10
		FAILURE_HIGH_PRESSURE_SWITCH(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21D.11
		FAILURE_FLOW_SWITCH(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21D.12
		FAILURE_DC_FAN_MOTOR_A(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21D.13
		FAILURE_DC_FAN_MOTOR_B(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21D.14
		FAILURE_EVAPORATING_PRESSURE(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21D.15
		
		FAILURE_HIGH_PRESSURE(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21E.00
		FAILURE_ROOM_TEMPERATURE_SENSOR(Doc.of(OpenemsType.BOOLEAN)), // 0X21E.01
		FAILURE_TW_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21E.02
		FAILURE_TC_sENSOR(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21E.03
		FAILURE_WATER_OUTLET(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21E.04
		FAILURE_WATER_INLET(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21E.05
		FAILURE_INDOOR_COIL_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21E.06
		FAILURE_VALVE1_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21E.07
		FAILURE_VALVE2_SENSOR(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21E.08
		FAILURE_COMM_LOST_PANEL_2(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21E.09
		FAILURE_INDOOR_EEPROM(Doc.of(OpenemsType.BOOLEAN)), 		// 0X21E.10
		FAILURE_PWM_SIGNAL(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21E.11
		FAILURE_VALVE1(Doc.of(OpenemsType.BOOLEAN)), 				// 0X21E.12
		FAILURE_VALVE2(Doc.of(OpenemsType.BOOLEAN)), 				// 0X21E.13
		FAILURE_INDOOR_ANTIFREEZE(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21E.14
		FAILURE_FLOW_SWITCH_PROTECTION(Doc.of(OpenemsType.BOOLEAN)),// 0X21E.15
		
		FAILURE_FLOW_SWITCH2(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21F.00
		FAILURE_INDOOR_COMM(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21F.01
		FAILURE_OUTDOOR_COMM(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21F.02
		FAILURE_LOW_OUTLET_TEMP_COOLING(Doc.of(OpenemsType.BOOLEAN)),// 0X21F.03
		FAILURE_HIGH_OUTLET_TEMP_IN_HEATING(Doc.of(OpenemsType.BOOLEAN)),// 0X21F.04
		FAILURE_DEFROST_FAILURE_REPEATED(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21F.05
		FAILURE_LOW_OUTLET_IN_HEATING(Doc.of(OpenemsType.BOOLEAN)), // 0X21F.06
		FAILURE_FLOW_SWITCH_REPEATED(Doc.of(OpenemsType.BOOLEAN)),	// 0X21F.07
		FAILURE_COIL_TEMP_PROTECTION(Doc.of(OpenemsType.BOOLEAN)), 	// 0X21F.08
		FAILURE_PREHEATING(Doc.of(OpenemsType.BOOLEAN)), 			// 0X21F.09
